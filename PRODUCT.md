...
- [x] Require `Repository signing-material policy / tracked-signing-material` before merging to `main` through GitHub branch protection or a ruleset.
